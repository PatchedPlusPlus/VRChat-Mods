...
[assembly: MelonModInfo(typeof(PortableMirror.Main), "PortableMirrorMod", "1.2.8", "M-oons,Nirvash")] //Name changed to break auto update
...
namespace PortableMirror
{
    ...
    public class Main : MelonMod
    {
        ...
        private void QuickMenuOptions()
        {
            ...
            mirrorMenu.AddLabel("Portable Mirror");
            ...
            if (_enableMicro)
            {
                mirrorMenu.AddLabel("Micro Mirror");
